...
local Linux = {}
Linux.CurrentTheme = "Green"
Linux.SelectedTheme = "Green"
Linux.Themes = {
...
Linux.FrameTransparency = 0.85
Linux.FrameColor = Color3.fromRGB(50, 50, 50)
Linux.MainFrameColor = Color3.fromRGB(23, 23, 23)
...
function Linux.LoadThemeSettings()
    local success, result = pcall(function()
        if readfile and isfile(Linux.ConfigFolder .. "/theme.json") then
            ...
            Linux.CurrentTheme = themeData.Theme or "Green"
...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            Btn.MouseEnter:Connect(function()
                TweenService:Create(BtnFrame, TweenInfo.new(0.2), {BackgroundTransparency = Linux.FrameTransparency - 0.07}):Play()
            end)
            ...
            Btn.MouseButton1Down:Connect(function()
                TweenService:Create(BtnFrame, TweenInfo.new(0.1), {BackgroundTransparency = Linux.FrameTransparency + 0.07}):Play()
            end)
                ...
                if confirmationConfig.Buttons then
                    for i, buttonConfig in ipairs(confirmationConfig.Buttons) do
                        local DialogButton = Linux.Instance("TextButton", {
                            Parent = ButtonsFrame,
                            BackgroundColor3 = i == 1 and Linux.Themes[Linux.CurrentTheme] or Linux.FrameColor,
                            BorderSizePixel = 0,
                            BorderColor3 = Color3.fromRGB(25, 25, 25),
    ...
    if config.ConfigSave ~= false then
        local SettingsTab = LinuxLib.Tab({
            Name = "UI",
            Icon = config.SettingsIcon or "rbxassetid://10734950309",
            Enabled = config.SettingsIconEnabled ~= false
        })
